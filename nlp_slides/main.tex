  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.48\textwidth}
      ...
      \begin{block}{RAG over MetaMathQA}
        Retrieves solved examples that expose relevant mathematical patterns
        and explanation styles. These examples ground the response in nearby
        problems instead of relying only on parametric memory.
      \end{block}
    \end{column}
    \begin{column}{0.48\textwidth}
...
\begin{frame}{AVSD Core Idea}
  ...
  prefixes under full solution, partial solution, final answer, and concise hint.
\end{frame}
...
\begin{frame}{Preparing Multi-view Data}
  ...
  \begin{tabular}{p{0.20\linewidth}p{0.36\linewidth}p{0.36\linewidth}}
    ...
    \midrule
    Partial solution &
    Initial reasoning steps or a truncated chain of thought. &
    ...
    \begin{column}{0.45\textwidth}
      \begin{block}{Training loop}
        \begin{enumerate}\tightitems
          \item Sample a math problem and privileged artifacts.
          \item Generate an on-policy rollout from the problem only.
          \item Build four teacher contexts: full, partial, answer, hint.
